...
# assigning a title
master.title("TECHNO INDIA NJR INSTITUTE OF TECHNOLOGY MARKSHEET")
...
# label to enter name
tk.Label(master, text="Student Name").grid(row=0, column=0)
...
tk.Label(master, text="Theory Of Computation 201").grid(row=3, column=1)
tk.Label(master, text="DBMS 202").grid(row=4, column=1)
tk.Label(master, text="DATA STRUCTURE 201").grid(row=5, column=1)
tk.Label(master, text="MICROPROCESSOR 201").grid(row=6, column=1)
